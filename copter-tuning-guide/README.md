...
> Αν πετάς 4.6 ή παλιότερα, δες το [Παράρτημα Α](A-Parameter-Mapping.md).
...
| [Α](A-Parameter-Mapping.md) | Παράρτημα Α | Αντιστοίχιση ονομάτων 4.6 → 4.7+ |
| [00](00-Course-Structure.md) | Δομή περιεχομένων | Το αρχικό table of contents |
