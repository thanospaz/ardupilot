...
> Η αρίθμηση ακολουθεί τα chapters του course, γι' αυτό ξεκινά από το **02**: το chapter 1
> ("Welcome and Introduction") και το 12 ("Close") δεν έχουν τεχνικό περιεχόμενο tuning και
> παραλείπονται. Δεν λείπει αρχείο.
