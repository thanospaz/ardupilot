...
| `FFT_WINDOW_SIZE` | — | Μέγεθος παραθύρου. Δύναμη του 2, 32–512. **256 μόνο για F7+, 512 για H7** |
| `FFT_WINDOW_OLAP` | — | Επικάλυψη παραθύρων. 0.5 (50 %) είναι καλή τιμή |
| `FFT_SAMPLE_MODE` | 0 | 0 = gyro rate sampling |
| `FFT_SNR_REF` | — | Κατώφλι SNR (dB) πάνω από το οποίο θεωρείται ότι υπάρχει σήμα |
| `FFT_ATT_REF` | 15 dB | Επίπεδο για υπολογισμό εύρους ζώνης της κορυφής |
| `FFT_HMNC_FIT` | — | Ποσοστό ανοχής για να θεωρηθεί μια κορυφή αρμονική άλλης. 0 = απενεργοποιημένο |
...
| `FFT_FREQ_HOVER` | — | **Μαθαίνεται αυτόματα** — η συχνότητα θορύβου στο hover |
| `FFT_THR_REF` | — | **Μαθαίνεται αυτόματα** — το throttle αναφοράς |
| `FFT_BW_HOVER` | — | **Μαθαίνεται αυτόματα** — το εύρος ζώνης στο hover |
